...
public class LevelMessages {
	public static void ShowLevelMessages(PlayerInfo currentPlayer, Graphics graphics, LevelStatus Levelstatus) {
	...
	private static void ShowMenu(PlayerInfo currentPlayer, Graphics graphics, LevelStatus Levelstatus) {
	...
	private static void ShowScoreBoard(PlayerInfo currentPlayer, Graphics graphics, LevelStatus Levelstatus) {
	...
	private static void ShowLevelNotStarted(PlayerInfo currentPlayer, Graphics graphics, LevelStatus Levelstatus) {
		if (Levelstatus == LevelStatus.LevelNotStarted) {
			...
			graphics.setColor(Color.BLUE);
			graphics.setFont(new Font("Arial", Font.BOLD, 28));
			graphics.drawString("Welcome to MGames.Tank", 190, 405);

			graphics.setColor(Color.WHITE);
			graphics.setFont(new Font("Tahoma", Font.BOLD, 12));
			graphics.drawString("Salaam " + currentPlayer.getPlayerName() + ", Press CTRL to start the game", 200, 440);
		}
	}

	private static void ShowGameOver(PlayerInfo currentPlayer, Graphics graphics, LevelStatus Levelstatus) {
	...
	private static void ShowLossLive(PlayerInfo currentPlayer, Graphics graphics, LevelStatus Levelstatus) {
	...
	private static void ShowLevelWinned(PlayerInfo currentPlayer, Graphics graphics, LevelStatus Levelstatus) {
